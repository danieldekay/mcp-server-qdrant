...
async def test_mcp_integration():
    ...
    if env_file.exists():
        ...
        print(f"❌ No .env file found. Set OPENAI_API_KEY and QDRANT_LOCAL_PATH in environment.")
        return False
    ...
    try:
        ...
        qdrant_path = os.environ.get("QDRANT_LOCAL_PATH", str(Path(__file__).parent.parent.parent.parent / "ai-for-profs-data" / "qdrant_db"))
